...
const (
	...
	// do not contaminate to user's existing storage accounts
...
func (a AzureClient) ConfigureNetworkSecurityGroup(ctx context.Context, deploymentCtx *DeploymentContext, resource azure.Resource, providedResourceGroup, location string,

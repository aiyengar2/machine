...
// OSDiskResource returns the Azure resource name for an OS disk resource
func (r ResourceNaming) OSDiskResource() string { return fmt.Sprintf(fmtOSDiskResource, r) }
